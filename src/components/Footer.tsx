            ...
            <div className="border-t border-gray-800 py-2">
              ...
              >
                <ul className="pl-2 py-2 text-base space-y-3 text-gray-400">
                  <li><TrackableLink to="/login" trackId="footer-investimento-regular" className="hover:text-white transition duration-300 block py-2 touch-highlight-none min-touch-target">Investimento Regular</TrackableLink></li>
                  <li><TrackableLink to="/login" trackId="footer-aposentadoria" className="hover:text-white transition duration-300 block py-2 touch-highlight-none min-touch-target">Aposentadoria</TrackableLink></li>
                  <li><TrackableLink to="/login" trackId="footer-imoveis" className="hover:text-white transition duration-300 block py-2 touch-highlight-none min-touch-target">Imóveis</TrackableLink></li>
                  <li><TrackableLink to="/login" trackId="footer-educacao" className="hover:text-white transition duration-300 block py-2 touch-highlight-none min-touch-target">Educação</TrackableLink></li>
                </ul>
              </div>
            </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><TrackableLink to="/login" trackId="footer-investimento-regular" className="hover:text-white transition duration-300">Investimento Regular</TrackableLink></li>
              <li><TrackableLink to="/login" trackId="footer-aposentadoria" className="hover:text-white transition duration-300">Aposentadoria</TrackableLink></li>
              <li><TrackableLink to="/login" trackId="footer-imoveis" className="hover:text-white transition duration-300">Imóveis</TrackableLink></li>
              <li><TrackableLink to="/login" trackId="footer-educacao" className="hover:text-white transition duration-300">Educação</TrackableLink></li>
              <li><TrackableLink to="/login" trackId="footer-protecao" className="hover:text-white transition duration-300">Proteção Patrimonial</TrackableLink></li>
            </ul>
          </div>
